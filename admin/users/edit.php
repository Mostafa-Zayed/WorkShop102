            ...
            <ul class="nav navbar-nav navbar-right be-user-nav">
              <li class="dropdown"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="dropdown-toggle"><img src="../assets/img/avatar.png" alt="Avatar"><span class="user-name">Túpac Amaru</span></a>
                <ul role="menu" class="dropdown-menu">
                  ...
                  <li><a href="../lgout.html"><span class="icon mdi mdi-power"></span> Logout</a></li>
                </ul>
              </li>
            </ul>
            ...
            <div class="left-sidebar-scroll">
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li><a href="users/show.html"><i class="icon mdi mdi-face"></i><span>Users</spa></a>
                  </li>
  ...
  <div class="main-content container-fluid">
    ...
    <div class="col-sm-12">
              <div class="panel panel-default panel-table">
                <div class="panel-heading" class="text-center"> <h2 class="text-center">Edit User </h4>
                </div>
                <div class="panel-body">
                  ...
                  <div class="login-form">
                    ...
                    <div class="form-group row login-submit">
                      <div class="col-xs-12">
                        <button  type="submit" class="btn btn-primary btn-xl" name="add">Update User</button>
                      </div>
                    </div>
                  </div>
                </form>
