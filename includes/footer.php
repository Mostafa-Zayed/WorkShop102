                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-footer-widget mb-80">
                        ...
                        <div class="footer-content mb-15">
                            <h3>Paris</h3>
                            <p class="mb-0">40 Baria Sreet 13/2 NY City, US</p>
                            <p class="mb-0">hello.colorlib@gmail.com</p>
                        </div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <!-- ******* All JS Files ******* -->
    <!-- jQuery js -->
    <script src="<?=FRONTEND_ASSETS_URL?>/js/jquery.min.js"></script>
    <!-- Popper js -->
    <script src="<?=FRONTEND_ASSETS_URL?>/js/popper.min.js"></script>
    <!-- Bootstrap js -->
    <script src="<?=FRONTEND_ASSETS_URL?>/js/bootstrap.min.js"></script>
    <!-- All js -->
    <script src="<?=FRONTEND_ASSETS_URL?>/js/uza.bundle.js"></script>
    <!-- Active js -->
    <script src="<?=FRONTEND_ASSETS_URL?>/js/default-assets/active.js"></script>
